...
export default function WhatsAppContact() {
  ...
  // Extract WhatsApp number from general settings
  const whatsAppNumber = data?.data?.general_settings?.find(
    (item) => item.key_id === "whatsApp"
  )?.value;
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        <svg fill="#fff" width={30} height={30} viewBox="0 0 308 308">
